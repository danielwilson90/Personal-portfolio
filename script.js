const projects = [
  {
    ...
    approach:
      "In collaboration with the CTO I helped develop across research, interface design, technical planning, and iteration. The work included intuitive Figma interfaces, product strategy, analytics-informed decisions, financial forecasting, and contributions to NSF, DOE, and ECAMS research grant proposals.",
    outcome:
