const projects = [
  {
    ...
    approach:
      "I co-led product development across resaearch, interface design, technical planning, and iteration. The work included intuitive Figma interfaces, product strategy, analytics-informed decisions, financial forecasting, and contributions to NSF, DOE, and ECAMS research grant proposals.",
    outcome:
